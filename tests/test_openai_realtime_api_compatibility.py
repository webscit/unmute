...
try:
    ...
    # Define stub types to satisfy type checker (tests will skip if not available)
    SessionUpdateEvent = None  # type: ignore[assignment,misc]
    InputAudioBufferAppendEvent = None  # type: ignore[assignment,misc]
    InputAudioBufferCommitEvent = None  # type: ignore[assignment,misc]
    InputAudioBufferClearEvent = None  # type: ignore[assignment,misc]
    ConversationItemCreateEvent = None  # type: ignore[assignment,misc]
    ConversationItemDeleteEvent = None  # type: ignore[assignment,misc]
    ConversationItemTruncateEvent = None  # type: ignore[assignment,misc]
    ResponseCreateEvent = None  # type: ignore[assignment,misc]
    ResponseCancelEvent = None  # type: ignore[assignment,misc]
    OutputAudioBufferClearEvent = None  # type: ignore[assignment,misc]
    SessionCreatedEvent = None  # type: ignore[assignment,misc]
    SessionUpdatedEvent = None  # type: ignore[assignment,misc]
    RealtimeErrorEvent = None  # type: ignore[assignment,misc]
    ConversationCreatedEvent = None  # type: ignore[assignment,misc]
    ConversationItemCreatedEvent = None  # type: ignore[assignment,misc]
    ConversationItemDeletedEvent = None  # type: ignore[assignment,misc]
    ConversationItemTruncatedEvent = None  # type: ignore[assignment,misc]
    InputAudioBufferCommittedEvent = None  # type: ignore[assignment,misc]
    InputAudioBufferClearedEvent = None  # type: ignore[assignment,misc]
    InputAudioBufferSpeechStartedEvent = None  # type: ignore[assignment,misc]
    InputAudioBufferSpeechStoppedEvent = None  # type: ignore[assignment,misc]
    ResponseDoneEvent = None  # type: ignore[assignment,misc]
    ResponseOutputItemAddedEvent = None  # type: ignore[assignment,misc]
    ResponseOutputItemDoneEvent = None  # type: ignore[assignment,misc]
    ResponseContentPartAddedEvent = None  # type: ignore[assignment,misc]
    ResponseContentPartDoneEvent = None  # type: ignore[assignment,misc]
    ResponseTextDeltaEvent = None  # type: ignore[assignment,misc]
    ResponseTextDoneEvent = None  # type: ignore[assignment,misc]
    ResponseAudioDeltaEvent = None  # type: ignore[assignment,misc]
    ResponseAudioDoneEvent = None  # type: ignore[assignment,misc]
    ResponseAudioTranscriptDeltaEvent = None  # type: ignore[assignment,misc]
    ResponseAudioTranscriptDoneEvent = None  # type: ignore[assignment,misc]
    ResponseFunctionCallArgumentsDeltaEvent = None  # type: ignore[assignment,misc]
    ResponseFunctionCallArgumentsDoneEvent = None  # type: ignore[assignment,misc]
    RateLimitsUpdatedEvent = None  # type: ignore[assignment,misc]
    ConversationItemInputAudioTranscriptionCompletedEvent = None  # type: ignore[assignment,misc]
    ConversationItemInputAudioTranscriptionFailedEvent = None  # type: ignore[assignment,misc]
    RealtimeConversationItemUserMessageParam = None  # type: ignore[assignment,misc]
    RealtimeResponse = None  # type: ignore[assignment,misc]
    RealtimeError = None  # type: ignore[assignment,misc]
